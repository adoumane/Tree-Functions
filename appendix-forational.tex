...
\end{tabular}
\end{center}
What is named $\rGamma$-FO in the table is what we simply called first-order logic along the paper. The operators of 2-CTL are those of Lemma~\ref{lem:schlingloff}.  
Schlingloff's theorem says that P-FO formulas are equivalent to 4-CTL formulas. To prove Lemma~\ref{lem:Schlingloff}, we need to prove that $\rGamma$-FO formulas are equivalent to 2-CTL ones. 
