...
%As usual, the proof requires a generalization of these results to $\lambda$-terms with ports. 
%Let us fix some notations for the rest of this appendix. Let $X$ be a finite set of typed variable. We define the set of \emph{\lambdaterms with ports} as 
%\begin{align*}
%\rlambda X = \tmonad \lamrank X
%\end{align*}
%where $\lamrank X$ is the ranked set
%\begin{align*}
%     \lamrank X= \overbrace{\set{x : x \in X}}^{\text{arity 0}} \cup \overbrace{\set{\lambda x : x \in X}}^{\text{arity 1}} \cup  \overbrace{\set @}^{\text{arity 2}}
%\end{align*}
...
\begin{center}
\includegraphics[scale=1.2]{redex.pdf}
\end{center}
...
\begin{center}
\includegraphics[scale=.7]{cases-lemma.pdf}
\end{center}
\end{itemize}
...
\begin{center}
\includegraphics[scale=.15]{MyPic15.jpg}
\end{center}
...
\begin{center}
\includegraphics[scale=.15]{MyPic16.jpg}
\end{center}  
...
\begin{center}
\includegraphics[scale=.15]{MyPic17.jpg}
\end{center}
...
\item Now consider the function 
 ...
 \end{align*}
 which is the identity function, except for the following finite set of terms for which it is defined as follows: 
\begin{center}
\includegraphics[scale=.15]{MyPic18.jpg}
\end{center}
...
\begin{center}
\includegraphics[scale=1]{full-redex.pdf}
\end{center}
...
\begin{align*}
\ranked{\tmonad \ranked{X^\lambda} \xrightarrow{\quad g\quad} \tmonad (\ranked{X^\lambda}+1) \xrightarrow{\quad \mathsf{block}^\uparrow\quad} \tmonad (\tmonad\ranked{X^\lambda}+\tmonad 1)
