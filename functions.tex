...
\begin{array}{ccc}
 ...
 \ranked{(\Sigma \otimes \Gamma)\otimes \Delta \to \Sigma \otimes (\Gamma\otimes \Delta)} & \ranked{(\Sigma + \Gamma)+ \Delta \to \Sigma + (\Gamma+ \Delta)}  & \ranked{(\Sigma \cdot \Gamma)\cdot \Delta \to \Sigma \cdot (\Gamma \cdot \Delta)}\\[15pt]
	...
	&
	 \simplefun
        ...
        {(\reduce k \Sigma_1) \otimes (\reduce k {\Sigma_2})}
         {\reduce k (\Sigma_1 \otimes \Sigma_2)}
        {\includegraphics[scale=.33]{tensor-fold-distrib-2}}  \\[5pt] 
        ...
        {\tmonad {\reduce k \Sigma}}
         ...
         {\includegraphics[scale=.33]{external-unfold-1}}
         \end{array}
$
