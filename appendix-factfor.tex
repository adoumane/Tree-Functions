...
In this section, we complete the proof of Proposition~\ref{prop:monotone-unfold}.  We say that a nested factorisation in $\tmonadn n \mati k \rSigma$ is monotone if all of the labels from $\mati k \rSigma$ that appear in it are monotone. 
