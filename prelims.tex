...
%We lift the function $ditribute_\otimes: \Sigma\otimes\Sigma^{\leq 1}\to  \Sigma\otimes\Sigma^{=0}+ \Sigma\otimes\Sigma^{= 1}$ to the trees of $\trees \Sigma\otimes\Sigma^{\leq 1}$ to get trees in $\trees (\)$.
