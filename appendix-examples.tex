...
%\subsection{Example of an FO tree-to-tree transduction}\label{sec:appendix-example-fo-transductions}
%
%
%\begin{example}\label{ex:pre-order}
%    Consider the ranked alphabets
%\begin{center}
%    \includegraphics[scale=.4]{pictures/input-alphabet}
%    
%    \includegraphics[scale=.4]{pictures/output-alphabet}
%\end{center}    
...
%\end{example}
%
%\subsection{Examples of derivable functions}
...
\noindent\begin{example}[Descendants and ancestors]\label{ex:descendant} If $\rSigma$ is a finite type and $\ranked{\rGamma\subseteq \rSigma}$, then the functions 
\begin{itemize}
...
%\begin{center}
%\includegraphics[scale=.3]{pictures/descendant.pdf}
%\end{center}
...
\begin{example}[Error raising.]\label{ex:error-raising}
...
\begin{example}[Partial functions.]
