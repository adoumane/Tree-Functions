...
We can think of the type $\ranked{1}$ as an error type. Indeed, the following raising error functions are derivable.
...
Thinking of $\ranked{1}$ as an error datatype, a function of type $\ranked{\Sigma \to \Gamma +1}$
