...
\subsubsection{Distribute fold over shallow terms}
...
\begin{align*}
    ...
    \end{align*}
% defined as follows. For every  $i \in\set{1,\dots,n}$,  if  $j\in\set{1,\dots,\arity{b_i}}$ then 
% \begin{align*}
...
\subsubsection{Distribute powers across shallow terms}
